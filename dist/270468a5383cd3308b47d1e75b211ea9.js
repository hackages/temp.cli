...
var externaleDeps = ['components/*/test/**/*.spec.js'].map(function (file) {
...
var testsFiles = path.resolve(context, 'components/*/test/**/*.spec.js');
var scriptsFiles = path.resolve(context, 'components/**/scripts/**/test/**/*.spec.js');
